...
use Syde\Vendor\Inpsyde\WorldlineForWoocommerce\ApplePayGateway\ApplePayGatewayModule;
use Syde\Vendor\Inpsyde\WorldlineForWoocommerce\BankTransferGateway\BankTransferGatewayModule;
...
use Syde\Vendor\Inpsyde\WorldlineForWoocommerce\GooglePayGateway\GooglePayGatewayModule;
use Syde\Vendor\Inpsyde\WorldlineForWoocommerce\HostedTokenizationGateway\HostedTokenizationGatewayModule;
use Syde\Vendor\Inpsyde\WorldlineForWoocommerce\IdealGateway\IdealGatewayModule;
...
return static function (): iterable {
    return [new EnvironmentModule(), new CoreModule(), new PaymentGatewayModule(), new LoggerModule(), new WorldlineLoggingModule(), new UriModule(), new WcSupportModule(), new ConfigModule(), new WorldlinePaymentGatewayModule(), new HostedTokenizationGatewayModule(), new GooglePayGatewayModule(), new ApplePayGatewayModule(), new BankTransferGatewayModule(), new IdealGatewayModule(), new CheckoutModule(), new ReturnPageModule(), new WebhooksModule(), new VaultingModule(), new UtilsModule(), new DocumentationModule(), new UninstallModule()];
};
