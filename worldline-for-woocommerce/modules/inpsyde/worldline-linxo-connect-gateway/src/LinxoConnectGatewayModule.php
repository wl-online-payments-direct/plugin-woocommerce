...
namespace Syde\Vendor\Worldline\Inpsyde\WorldlineForWoocommerce\LinxoConnectGateway;
...
class LinxoConnectGatewayModule implements ServiceModule, ExtendingModule
{
    use ModuleClassNameIdTrait;
    public const PACKAGE_NAME = 'worldline-linxo-connect-gateway';
