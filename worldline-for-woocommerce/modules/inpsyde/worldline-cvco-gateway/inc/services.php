...
return static function (): array {
    ...
    return [
        ...
        __('Cheque Vacances Connect (Worldline)', 'worldline-for-woocommerce'),

        "payment_gateway.$gatewayId.title" => static fn () =>
        __('Cheque Vacances Connect', 'worldline-for-woocommerce'),

        "payment_gateway.$gatewayId.method_description" => static fn (): string =>
        __(
            'Accept payments with Cheque Vacances Connect.',
        ...
        "payment_gateway.$gatewayId.method_icon_provider" => new Factory([
            ...
            $src = $getStaticAssetUrl(
                CVCOGatewayModule::PACKAGE_NAME,
                "images/cvco-logo.svg"
            );
        ...
        "cvco.request_modifier" => new Constructor(
            CVCORequestModifier::class,
            []
        ),
    ];
};
