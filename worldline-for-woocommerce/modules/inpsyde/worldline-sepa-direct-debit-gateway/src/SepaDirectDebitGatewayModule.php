...
namespace Syde\Vendor\Worldline\Inpsyde\WorldlineForWoocommerce\SepaDirectDebitGateway;
...
class SepaDirectDebitGatewayModule implements ServiceModule, ExtendingModule
{
    use ModuleClassNameIdTrait;
    public const PACKAGE_NAME = 'worldline-sepa-direct-debit-gateway';
