...
return static function (): array {
    return ['vaulting.bin_parser' => new Constructor(CardBinParser::class), 'vaulting.repository.wc.tokens' => new Constructor(WcTokenRepository::class, ['vaulting.bin_parser']), 'vaulting.card_button_renderer' => new Constructor(CardButtonRenderer::class)];
};
